    ...
    try:
        ...
        if text.startswith("ค้นหา:"):
            ...
            messages = [{"role": "system", "content": (
                "คุณชื่อพี่หลาม พูดไทยแบบกันเอง ใช้ภาษาพูดเต็มที่ จะหยาบนิดๆ ก็ได้ถ้าเข้ากับบริบท "
                "ไม่ต้องชวนคุยส่งท้ายทุกครั้ง ให้คุยเหมือนคนจริงๆ พูดตรงๆ ได้ ถ้าอะไรไม่เวิร์คก็ว่าไปตามนั้น "
                "ให้คำปรึกษาจริงจังได้เมื่อจำเป็น และมีกำลังใจให้เวลาเหมาะสม"
            )}]
